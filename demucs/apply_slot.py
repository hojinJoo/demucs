...
def apply_model_slot(model: tp.Union[BagOfModels, Model],
    ...
    if isinstance(model, BagOfModels):
        ...
        for sub_model, model_weights in zip(model.models, model.weights):
            ...
            res = apply_model_slot(sub_model, mix, **kwargs, callback_arg=callback_arg)
            if res is None:
                return res
            out = res
    ...
    if shifts:
        ...
        for shift_idx in range(shifts):
            ...
            res = apply_model_slot(model, shifted, **kwargs, callback_arg=callback_arg)
            if res is None:
                return res
            shifted_out = res
        ...
        for offset in offsets:
            ...
            future = pool.submit(apply_model_slot, model, chunk, **kwargs, callback_arg=callback_arg,
